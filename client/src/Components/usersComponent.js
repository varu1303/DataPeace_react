    ...
    return (
      <div>
        ...
        <p className="containP">
            ...
            <span onClick={ () => {if (this.state.currentScroll - 5 > 0) {this.setState((prevState) => ({ currentScroll: prevState.currentScroll - 5}))}} } className="dir"> <i className="fas fa-angle-left"></i>  </span>
            ...
            <span onClick={ () => {if (this.state.currentScroll + 5 < this.state.pages) {this.setState((prevState) => ({ currentScroll: prevState.currentScroll + 5}))}} } className="dir"> <i className="fas fa-angle-right"></i>  </span>
