    ...
    return (
      <div>
        ...
        <p className="containP">
            ...
            <span onClick={ () => {if (this.state.currentPage !== Math.ceil(this.state.users / 5)) {this.setState((prevState) => ({ currentScroll: prevState.currentScroll + 5}))}} } className="dir"> <i className="fas fa-angle-right"></i>  </span>
